    ...
    <div className="mondrian-info">
      ...
      <div className="mondrian-content">
        ...
        <p>
          ...
          naturalism to abstraction. His early tree works, like "The Red Tree" (1908), still depicted recognizable
          trees with expressionistic colors and visible brushwork. As the series progressed through "Gray Tree" (1911)
          and "Blossoming Apple Tree" (1912), the forms became increasingly simplified, with branches reduced to rhythmic
        ...
        <p>
          By the time of "Composition Trees II" (1912-1913), the tree had been almost entirely abstracted into a
          network of horizontal and vertical lines with subtle curves. This transformation reflected Mondrian's
          philosophical pursuit of universal harmony and spiritual truth, which he believed existed beyond the visible
          world. He sought to express the essential, underlying structure of nature rather than its superficial
          appearance.
        </p>
        <p>
