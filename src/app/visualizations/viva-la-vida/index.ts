  ...
  settings: {
    ...
    visualization: {
      ...
      creaminess: {
        id: 'creaminess',
        name: 'Creaminess',
        description: 'Brush paint texture detail',
        type: SettingType.NUMBER,
        value: 0.2,
        params: { min: 0.05, max: 1.0, step: 0.05 },
      },
      dryness: {
        id: 'dryness',
        name: 'Dryness',
        description: 'Paint drying effect',
        type: SettingType.NUMBER,
        value: 0.1,
      ...
      strokeWidth: {
        id: 'strokeWidth',
        name: 'Stroke Width',
        description: 'Brush stroke width',
        type: SettingType.NUMBER,
        value: 0.2,
        params: { min: 0.05, max: 1.0, step: 0.05 },
      },
      pouringSize: {
        id: 'pouringSize',
        name: 'Pouring Size',
        description: 'Mouse click paint size',
        type: SettingType.NUMBER,
        value: 0.2,
        params: { min: 0.05, max: 1.0, step: 0.05 },
      },
      pouringAmount: {
        id: 'pouringAmount',
        name: 'Pouring Amount',
        description: 'Amount of paint poured on click',
        type: SettingType.NUMBER,
        value: 0.5,
        params: { min: 0.1, max: 1.0, step: 0.1 },
      },
      falloff: {
        id: 'falloff',
        name: 'Falloff',
        description: 'Noise falloff rate',
        type: SettingType.NUMBER,
        value: 1.4,
        params: { min: 0.1, max: 2.0, step: 0.1 },
      },
