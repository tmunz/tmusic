...
const neverGonnaGiveYouUp: Visualization = {
  ...
  color: '#252525',
  settings: {
    samples: createSampleSettings(336, 107, 10, 10000, false, 0.5),
    visualization: {
      record: {
        id: 'record',
        name: 'Record',
      ...
      stroboscopicEffect: {
        ...
        description: 'Creates a freeze-frame effect by reducing rotation update frequency (0.0 = smooth, 1.0 = maximum stroboscopic effect).',
        type: SettingType.NUMBER,
        value: 0.95,
        params: {
          min: 0.0,
